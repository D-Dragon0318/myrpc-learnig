package io.spridra.rpc.common.scanner.reference;
...
import static io.spridra.rpc.common.scanner.ClassScanner.getClassNameList;

/**
 * @Author: Spridra
 * @CreateTime: 2025-05-27 09:33
 * @Describe: @RpcReference注解扫描类
 * @Version: 1.0
 */
